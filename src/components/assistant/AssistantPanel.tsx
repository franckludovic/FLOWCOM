...
const COPY = {
  fr: {
    ...
    noKey: "L'assistant IA n'est pas encore activé pour votre espace. Contactez votre gestionnaire FlowCom.", noCompany: 'Sélectionnez une entreprise.',
  ...
  en: {
    ...
    noKey: 'The AI assistant is not enabled for your workspace yet. Contact your FlowCom manager.', noCompany: 'Select a company.',
