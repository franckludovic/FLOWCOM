...
import {
  BookMarked, Search, Filter, Trash2, Edit2, Save, Copy
} from 'lucide-react'
import {
        ...
        {items.length === 0 ? (
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
            {filteredItems.map(item => {
              ...
              return (
                <div key={item.id} className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl overflow-hidden flex flex-col shadow-sm hover:shadow-md transition-shadow">
